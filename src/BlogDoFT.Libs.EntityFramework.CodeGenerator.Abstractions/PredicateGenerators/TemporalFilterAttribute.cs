...
/// <summary>
/// Declares filter semantics for temporal properties (date, time, or date-time).
/// </summary>
/// <example>
/// <code>
/// [TemporalFilter(TargetProperty = "CreatedAt", Operator = ComparisonOperator.LessThanOrEqual, Order = 3)]
/// public DateTime? CreatedUntil { get; init; }
/// </code>
/// </example>
[AttributeUsage(AttributeTargets.Property)]
public sealed class TemporalFilterAttribute : Attribute
{
    /// <summary>
